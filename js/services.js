document.addEventListener('DOMContentLoaded', function() {
    ...
    const weddingServices = [
      {
        icon: 'mic',
        title: 'Ведущий свадьбы',
        subtitle: 'Продолжительность программы: от 1 до 7 часов. Проведение мероприятия',
        description: 'Моя задача создать особую атмосферу на вашем событии и объединить каждого гостя, познакомить и помочь комфортно провести время на празднике.',
        price: '25 000 руб. / час'
      },
      {
        icon: 'file-text',
        ...
        price: '3 500 - 20 000 руб.'
      },
      {
        icon: 'camera',
        title: 'Фотосъёмка свадьбы',
        subtitle: '22 Мп. Съёмка мероприятия и обработка материалов',
        description: 'У нас большой выбор фотографов для любого праздника. В результате вы получаете качественные фото с полной обработкой.',
        price: '1 400 руб. / час'
      },
      {
        icon: 'video',
        title: 'Видеосъёмка свадьбы',
        subtitle: 'В формате FullHD, от 1920 × 1080. Съёмка мероприятия и обработка материалов',
        description: 'У нас большой выбор операторов для любого праздника. В результате вы получаете качественное видео с монтажом.',
        price: '1 800 руб. / час'
      },
      {
        icon: 'users',
        title: 'Встреча молодоженов',
        subtitle: 'Продолжительность: до 15 минут. Традиционная встреча молодой пары на площадке',
        description: 'Славянская свадьба никогда не обходилась без встречи караваем молодых, приехавших из церкви после венчания.',
        price: '2 000 руб.'
      },
      {
        icon: 'heart',
        title: 'Выкуп невесты',
        subtitle: 'Продолжительность: до 1 часа. Планирование и организация шоу-программы "Выкуп невесты"',
        description: 'Самым ярким моментом в свадебное утро, конечно же, является приезд жениха к невесте и, соответственно, выкуп невесты.',
        price: '7 000 руб.'
      },
      {
        icon: 'music',
    ...
    weddingServices.forEach((service, index) => {
      ...
      serviceItem.className = `wedding-service-item ${service.wide ? 'wedding-wide-service' : ''}`;
